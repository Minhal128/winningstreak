...
type Props = NativeStackScreenProps<RootStackParamList, 'SignUp5'>;
...
export default function ANISHKFFSignup5v2Component({ navigation }: Props) {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          {/* Label */}
          <Text style={styles.label}>Provide an email address</Text>
